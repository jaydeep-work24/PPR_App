...
class AppConstants {
  // http://13.232.145.143/api/web/signinappdata
  static const String APP_NAME = 'PPR';
  static const String BASE_URL = 'http://13.232.145.143';
  ...
  static const String SIGNIN_URI = '/api/web/signinapp';
  static const String SIGNIN_GET_USER_DATA_URI = '/api/web/signinappdata';
  static const String SIGNUP_URI = '/api/web/signupapp';
  static const String PPrefrence_URI = '/api/web/pprefrence';
  static const String COUNTRY_URI = '/api/web/country/list';
  static const String STATE_URI = '/api/web/state/list/';
  static const String CITY_URI = '/api/web/citybystate/';
  static const String ZIPCODE_URI = '/api/web/zipcode/listbycity/';
  ...
  static const String BEARER_TOKEN = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2MmJkNDI0MTVmNzQyZTRiMTZjYzZmOWUiLCJpYXQiOjE2NTk0MzkyNDEsImV4cCI6MTY2MjAzMTI0MX0.FdDEqR62FK6zl5xqpdPDQyq8r9W7BCbDLsyWJoiJy3Q';
